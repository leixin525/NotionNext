...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '5d3d07bee58348799a9c5935a86e5a0c',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '凉橙', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.liangchen.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '美甲, 凉橙', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo', // 分享的服務，按顺序显示,逗号隔开
